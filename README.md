Logistic Regression Classifier in SciKitLearn for Multi-class Classification - Base problem category as per Ready Tensor specifications.
...
Logistic Regression is a linear model. It provides interpretable results by default.
